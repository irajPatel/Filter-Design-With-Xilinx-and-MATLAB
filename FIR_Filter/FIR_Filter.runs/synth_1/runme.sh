...
HD_PWD='E:/@VLSI/FIR_Filter/FIR_Filter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR_Filters.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIR_Filters.tcl
